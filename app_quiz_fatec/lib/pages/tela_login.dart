        ...
        child: Column(
          ...
          children: [
            SizedBox(
              ...
              child: Expanded(
                child: CircleAvatar(
                  backgroundImage: AssetImage('lib/images/quiz_logo.jpg'),
                )
              ),
            ),
                ...
                TextButton(
                  child: Text(
                    ...
                    style: GoogleFonts.roboto(
                      fontSize: 16,
                      color: Color.fromARGB(255, 23, 0, 27),
                    ),
                  ),
                  onPressed: () {
                    showDialog(
                      ...
                      builder: (context) => AlertDialog(
                        ...
                        actions: [
                          ...
                          TextButton(
                            style: TextButton.styleFrom(
                              backgroundColor: Color.fromARGB(255, 16, 1, 29),
                              minimumSize: Size(120, 50),
                            ),
                            onPressed: () async {
            ...
            ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                primary: Color.fromARGB(255, 25, 1, 29),
              ...
              children: [
                TextButton(
                  child: Text(
                    ...
                    style: GoogleFonts.roboto(
                      fontSize: 16,
                      color: Color.fromARGB(255, 20, 2, 41),
                    ),
                  ),
